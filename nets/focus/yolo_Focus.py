...
from nets.backbone_Focus import Focus_Up, Focus_Down
...
class YoloBody(nn.Module):
    def __init__(self, input_shape, num_classes, phi, pretrained=False):
        ...
        self.upsample1 = Focus_Up(int(base_channels * 16 * deep_mul), int(base_channels * 16 * deep_mul))
        # 512, 40, 40 => 512, 80, 80
        self.upsample2 = Focus_Up(int(base_channels * 8 * deep_mul), int(base_channels * 8 * deep_mul))
