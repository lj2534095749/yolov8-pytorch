...
class PatchEmbed(nn.Module):
    ...
    def forward(self, x):
        ...
        if pad_input:
            # to pad the last 3 dimensions, W_right & H_bottom
        ...
        # --------------------------------------- #
        #   Patch Partition  下采样patch_size倍
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, attn_drop=0., proj_drop=0.):
        ...
        # Mh Mw is window_size
        # 2*Mh-1 * 2*Mw-1 是不重复的相对位置索引的个数
        ...
        # pytorch的最新版本(1.9.0以上)不支持indexing="ij"参数
        ...
        # [2, Mh*Mw, 1] - [2, 1, Mh*Mw]
        relative_coords = coords_flatten[:, :, None] - coords_flatten[:, None, :]  # [2, Mh*Mw, Mh*Mw]  相对位置索引
        ...
        nn.init.trunc_normal_(self.relative_position_bias_table, std=.02)  # 相对位置偏执参数
    ...
    def forward(self, x, mask: Optional[torch.Tensor] = None):
        ...
        # relative_position_bias.unsqueeze(0): -> [1, num_heads, Mh*Mw, Mh*Mw]
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x, attn_mask):
        ...
        if self.shift_size > 0:
            # 移动窗口，使其计算时的窗口大小相等，首先H下移shift_size，然后W右移shift_size
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, depth, num_heads, window_size,
        ...
        self.shift_size = window_size // 2  # default 3
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, patch_size=4, in_chans=3, num_classes=1000,
                 ...
                 window_size=10, mlp_ratio=4., qkv_bias=True,
